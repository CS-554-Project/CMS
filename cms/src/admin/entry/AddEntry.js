      ...
      case "small-text-input":
        return (
          <div key={index}>
            <SmallTextInput
              data={field}
              handleInputChange={e => this._handleInputChange(e, field.type)}
            />
          </div>
        );
        ...
        return (
          <div key={index}>
            <ImageUpload
              data={field}
              handleInputChange={e => this._handleInputChange(e, field.type)}
              resizeImage={e => this._resizeImage(e)}
            />
          </div>
        );
    ...
    return (
      <div className="container">
        ...
        <form>
          ...
          <div className="form-group row">
            <label className="col-sm-2 col-form-label" for="entryTitle">
              Entry Title
            </label>
            <div className="col-sm-10">
              <input
          ...
          <div className="form-group row">
            <label className="col-sm-2 col-form-label" for="entrySlug">
              Entry Slug
            </label>
            <div className="col-sm-10">
              <input
                ...
                value={this.state.entrySlug}
                onChange={this._handleChange}
              />
            </div>
          </div>
          <div className="form-group row">
            <label className="col-sm-2 col-form-label" for="entryBlurb">
              Entry Blurb
            </label>
            <div className="col-sm-10">
              <input
                ...
                id="entryBlurb"
                className="form-control"
                placeholder="Entry Blurb"
                value={this.state.entryBlurb}
                onChange={this._handleChange}
              />
            </div>
          </div>
