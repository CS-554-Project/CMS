                ...
                <tbody>
                    {this.state.structureList.map(structure =>
                        <tr key={structure.key}>
                            ...
                            <td key={structure.key}><button className="btn btn-info" onClick={() => this.editStructure(structure)} value={structure.slug}>Edit</button></td>                            
                            <td key={structure.key}><button className="btn btn-danger" onClick={() => this.removeStructure(structure)} value={structure.slug}>Delete</button></td>                            
                        </tr>
                    )}  
                </tbody>          
            </table>
